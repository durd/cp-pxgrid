...
# init logging
log = logging.getLogger("cp-pxgrid-bulkdl")
...
if __name__ == '__main__':
    ...
    delta = datetime.utcnow().replace(tzinfo=timezone.utc).astimezone() - timedelta(hours=cfg.fetchhours)

    loop = asyncio.get_event_loop()
    bulkdl = asyncio.ensure_future(query(config, secret, url, f'{{"startTimestamp": "{delta.isoformat()}"}}'))
